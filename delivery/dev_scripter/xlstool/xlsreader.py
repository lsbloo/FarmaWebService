...
class ReaderXLS(object):
    ...
    def gerenate_data_anvisa(self,woorkbook):
        ...
        laboratorio = anvisa_med.sheet_by_index(0).col(2)
        registro = anvisa_med.sheet_by_index(0).col(4)
        ean1 = anvisa_med.sheet_by_index(0).col(5)
        ean2 = anvisa_med.sheet_by_index(0).col(6)
        produto = anvisa_med.sheet_by_index(0).col(8)
        apresentacao = anvisa_med.sheet_by_index(0).col(9)
        classe = anvisa_med.sheet_by_index(0).col(10)
        tipo = anvisa_med.sheet_by_index(0).col(11)
        registricao=anvisa_med.sheet_by_index(0).col(13)
        tarja = anvisa_med.sheet_by_index(0).col(18)
